...
public class DataCleanManager {
    /**
     * * 清除本应用内部缓存(/data/data/com.xxx.xxx/cache) * * 一般用这个     *     * @param context
     */
    ...
    public static void cleanDatabases(Context context) {
        deleteFilesByDirectory(new File("/data/data/com.zhonglian.battleworld/databases"));
    }
    ...
    public static void cleanSharedPreference(Context context) {
        deleteFilesByDirectory(new File("/data/data/com.zhonglian.battleworld/shared_prefs"));
    }
