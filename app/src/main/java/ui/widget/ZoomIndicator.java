...
public class ZoomIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public ZoomIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSelector = ta.getResourceId(R.styleable.ZoomIndicator_zoom_selector,
                R.drawable.bottom_rectangle_shape);
        mSelectorDefaul = ta.getResourceId(R.styleable.ZoomIndicator_zoom_selector,
                R.drawable.bottom_rectangle_shape_defual);
        ...
        if (bean != null) {
            ...
            for (int i = 0; i < mCount; i++) {
                ...
                if (i==0) {
                    ...
                    imageView.setBackgroundResource(mSelectorDefaul);
                }
    ...
    private void viewPagerSeleted(int position) {
        ...
        if (mLastPosition >= 0) {
            ...
            if (lastView != null) {
                ...
                lastView.setBackgroundResource(mSelectorDefaul);
        ...
        if (currentView != null) {
            ...
            currentView.setBackgroundResource(mSelector);
            ;
        }
