...
public class UnlockView extends View {
    ...
    private int pathWidth = 2;//width of the paint of path
    private int normalR = 10;//radius of small circles;
    private int selectR = 15;//radius of big circles;
    private int strokeWidth = 1;//width of big circles;
    private int normalColor = Color.parseColor("#B3BAC9");//defalt color of normal state
    private int selectColor = Color.parseColor("#04C5FC");//defalt color of selected state
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (pathCircleList.size() > 0&&pathCircleList.size()>=5) {
                    mPath.reset();
                    mPath.addPath(tempPath);
                    ...
                    Toast.makeText(ctx, "请至少输入5个点!", Toast.LENGTH_SHORT).show();
                    resetAll();
                }
                break;
        }
